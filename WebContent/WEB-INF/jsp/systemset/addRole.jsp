...
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	...
	<tr>
		<th>创建人</th>
		<td><input  value="<%=request.getParameter("usrName") %>" readonly size="20" /><span class="red_star">*</span></td>
	</tr>
	<tr>
    	<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
        	<a href="help.html"><!-- <input class="common_button"  type="button" value="帮助"> --></a>
        	&nbsp;&nbsp;&nbsp;
			<a href="sysrole/selectAllSysRole.action"><input class="common_button"  type="button" value="返回"></a>
&nbsp;&nbsp;
